...
# LEAP ARLO - modified by Jonathan Lacombe (I know what I am doing) #
# Adds .so library to sys.path if lib is found relative to this frame
import os, sys, inspect
src_dir = os.path.dirname(inspect.getfile(inspect.currentframe()))

arch_dir = '../../../include/x64' if sys.maxsize > 2**32 else '../../../include/x86'
